...
# Revision History
#
# R. Hempel 26Dec2003 - puts to the console are commented out
...
proc ::rcxterm::rcvHandler { } {
  ...
  puts -nonewline "$::rcxterm::rcvHandlerCount "
  ...
  if { 0 == [string length $inData] } {
    if { 50 == [incr rcxterm::rcvHandlerCount] } {
      set rcxterm::rcvEvent TIMEOUT
      set rcxterm::rcvTimeout 1
      }
...
proc ::rcxterm::putConsole { s } {
  ...
  set ::rcxterm::rcvTimeout 0

  rcxComm::portWrite $::rcxComm::portID $s

#  puts "Writing to console $s"
